...
<head>
    ...
    <link rel="stylesheet" href="./sinhvien/sp_SinhVien/header.css">
    <link rel="stylesheet" href="./sinhvien/sp_SinhVien/taiKhoan.css">
    <link rel="stylesheet" href="./sinhvien/sp_SinhVien/chuong.css">
...
<body>
    ...
    <header>
        ...
        <div class="navbar" style="background-color: #b3e5fc;">
            <div class="logo">
                <a href="index.php" style="padding:0;">
                    <img src="./sinhvien/img/logo.png" alt="Fast Learn Logo">
                </a>
            </div>
            ...
            <div class="user-profile" style="width: 200px; display: flex; align-items: center; justify-content: space-evenly;">
                ...
                <script src="./sinhvien/js/tk.js"></script>
            </div>
    </header>
